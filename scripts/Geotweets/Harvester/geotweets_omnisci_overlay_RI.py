...
conn=connect(user="admin", password="HyperInteractive", host="localhost", port=8295, dbname="omnisci") #use your port number
...
for filename in all_files:
    ...
    try:
       ...
       conn.execute("INSERT INTO geotweets_fips (Select a.* from geotweets a inner join RI b ON ST_Intersects(b.omnisci_geo,ST_SetSRID(ST_Point(a.longitude,a.latitude),4326)));")
