...
for filename in all_files:
    ...
    try:
       ...
       conn.execute("INSERT INTO geotweets_india (Select a.* from geotweets a, india b WHERE ST_Intersects(b.omnisci_geo,ST_SetSRID(ST_Point(a.longitude,a.latitude),4326)));")
       #conn.execute("Drop table if exists geotweets;")
    except:
       print("Not loaded geotweets_india")
