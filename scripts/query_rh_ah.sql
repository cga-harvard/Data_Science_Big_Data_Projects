...
\copy resultstdmean from '/n/holyscratch01/cga/dkakkar/data/tdmean_results.csv' (FORMAT csv, delimiter ',', CSV HEADER);

Create table resultstmean (address_id character varying(255),day date, tmean FLOAT);


\copy resultstmean from '/n/holyscratch01/cga/dkakkar/data/tmean_results.csv' ((FORMAT csv, delimiter ',', CSV HEADER);
